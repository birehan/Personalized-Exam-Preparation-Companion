      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextFormField(
            ...
            validator: (quizTitle) => validateQuizTitle(quizTitle, context),
          ),
          ...
          CustomTextFormField(
            ...
            validator: (quizNumber) => validateQuizQuestionsNumber(quizNumber, context),
          ),
          ...
          BlocListener<ChapterBloc, ChapterState>(
            listener: (context, state) {
              if (state is SubChaptersFailedState) {
