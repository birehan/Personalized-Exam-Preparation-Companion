...
abstract class ProfileRemoteDataSource {
  ...
  Future<LeaderboardModel> getTopUsers(
...
class ProfileRemoteDataSourceImpl implements ProfileRemoteDataSource {
  ...
  Future<LeaderboardModel> getTopUsers(
    ...
    try {
      ...
      if (leaderboardType == LeaderboardType.allTime) {
      ...
      } else if (leaderboardType == LeaderboardType.weekly) {
        response = await client.get(
          Uri.parse('$baseUrl/user/weeklylLeaderboard?page=$page&limit=20'),
          headers: {
            'content-Type': 'application/json',
            'authorization': 'Bearer $token'
          },
        ...
        response = await client.get(
          Uri.parse('$baseUrl/user/monthlyLeaderboard?page=$page&limit=20'),
          headers: {
            'content-Type': 'application/json',
            'authorization': 'Bearer $token'
          },
