...
class _FakeMockDetailModel_2 extends _i1.SmartFake
    implements _i2.MockDetailModel {
  _FakeMockDetailModel_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockMockExamRemoteDatasource extends _i1.Mock
  ...
  @override
  _i3.Future<_i2.MockDetailModel> getMockDetail(String? mockId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getMockDetail,
          [mockId],
        ...
        returnValue:
            _i3.Future<_i2.MockDetailModel>.value(_FakeMockDetailModel_2(
          this,
          Invocation.method(
            #getMockDetail,
            [mockId],
      ...
      ) as _i3.Future<_i2.MockDetailModel>);

  @override
  _i3.Future<void> downloadMockById(String? mockId) => (super.noSuchMethod(
        Invocation.method(
          #downloadMockById,
          [mockId],
        ),
...
class MockMockExamLocalDatasource extends _i1.Mock
  ...
  @override
  _i3.Future<void> cacheDownloadedMock(dynamic mock) => (super.noSuchMethod(
        Invocation.method(
          #cacheDownloadedMock,
          [mock],
        ),
  ...
  @override
  _i3.Future<List<_i2.DownloadedUserMockModel>> fetchDownloadedMocks() =>
      (super.noSuchMethod(
        Invocation.method(
          #fetchDownloadedMocks,
          [],
        ),
        returnValue: _i3.Future<List<_i2.DownloadedUserMockModel>>.value(
            <_i2.DownloadedUserMockModel>[]),
        returnValueForMissingStub:
            _i3.Future<List<_i2.DownloadedUserMockModel>>.value(
                <_i2.DownloadedUserMockModel>[]),
      ) as _i3.Future<List<_i2.DownloadedUserMockModel>>);

  @override
  _i3.Future<void> markMockAsDownloaded(String? mockId) => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<bool> isMockDownloaded(String? mockId) => (super.noSuchMethod(
        Invocation.method(
          #isMockDownloaded,
          [mockId],
        ),
  ...
  @override
  _i3.Future<void> upsertUserMockScore(
    String? mockId,
    int? score,
    bool? isCompleted,
  ) =>
  ...
  @override
  _i3.Future<void> upsertUserMockAnswer(
    String? mockId,
    List<_i2.QuestionUserAnswer>? userAnswers,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #upsertUserMockAnswer,
          [
            mockId,
            userAnswers,
          ],
