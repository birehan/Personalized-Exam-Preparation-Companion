...
void main() {
  ...
  const question = Question(
      ...
      isForQuiz: true);
  const userAnswer =
      UserAnswer(userId: tId, questionId: tId, userAnswer: "userAnswer");
  const mockQuestion = MockQuestion(question: question, userAnswer: userAnswer);
  const mock = mocks.Mock(
      id: tId, name: "name", userId: tId, mockQuestions: [mockQuestion]);
  ...
  test(
    ...
    () async {
      ...
      final result =
          await usecase.call(const MockExamParams(id: tId, pageNumber: 1));
