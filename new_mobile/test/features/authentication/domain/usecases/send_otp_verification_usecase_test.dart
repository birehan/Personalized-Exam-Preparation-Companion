...
import 'package:prep_genie/features/authentication/domain/usecases/send_otp_verification_usecase.dart';
...
void main() {
  ...
  setUp(() {
    ...
    sendOtpVerificationUsecase =
        SendOtpVerificationUsecase(repository: mockRepository);
  });
