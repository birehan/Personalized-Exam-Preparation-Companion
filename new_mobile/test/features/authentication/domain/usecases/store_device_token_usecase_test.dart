...
import 'package:prep_genie/features/authentication/domain/usecases/store_device_token_usecase.dart';
...
void main() {
  ...
  setUp(() {
    ...
    storeDeviceTokenUsecase =
        StoreDeviceTokenUsecase(repository: mockRepository);
  });
  ...
  group('StoreDeviceTokenUsecase', () {
    test('should call the repository to store device token', () async {
      ...
      // Act
      when(mockRepository.storeDeviceToken())
