...
import 'package:prep_genie/features/authentication/domain/usecases/logout_with_google_usecase.dart';
...
void main() {
  ...
  setUp(() {
    ...
    signOutWithGoogleUsecase =
        SignOutWithGoogleUsecase(repository: mockRepository);
  });
  ...
  group('SignOutWithGoogleUsecase', () {
    test('should call the repository to sign out with Google', () async {
      ...
      // Act
      when(mockRepository.logoutWithGoogle())
