...
@GenerateNiceMocks([MockSpec<GetDepartmentCourseUsecase>()])
void main() {
  ...
  setUp(() {
    ...
    bloc = DepartmentCourseBloc(
        getDepartmentCourseUsecase: mockGetDepartmentCourseUsecase);
  });
  ...
  group('_onGetDepartmentCourse', () {
    ...
    test('should emit [Loading, Error] when getting data fails', () async {
      ...
      final expected = [
        const GetDepartmentCourseState(status: DepartmentCourseStatus.loading),
        const GetDepartmentCourseState(status: DepartmentCourseStatus.error)
      ];
      expectLater(bloc.stream, emitsInOrder(expected));
      // act
      bloc.add(const GetDepartmentCourseEvent(id: tId));
