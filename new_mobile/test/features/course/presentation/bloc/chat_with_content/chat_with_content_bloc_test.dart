...
@GenerateNiceMocks([MockSpec<ChatWithContentUsecase>()])
void main() {
  ...
  group('_onChat', () {
    ...
    test('should emit [Loading, Loaded] when data is gotten successfully', () {
      ...
      final expected = [
        ...
        const SendChatWithContentState(
            status: ChatStatus.loaded, chatResponse: chatResponse)
      ];
    ...
    test('should emit [Loading, Error] when getting data fails', () async {
      ...
      final expected = [
        const SendChatWithContentState(status: ChatStatus.loading),
        const SendChatWithContentState(status: ChatStatus.error)
      ];
      expectLater(bloc.stream, emitsInOrder(expected));
      // act
      bloc.add(const SendChatWithContentEvent(chatBody: chatBody));
