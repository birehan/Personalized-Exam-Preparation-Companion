...
void main() {
  ...
  final courseDepartment = CourseModel(
      chapters: chapters,
  ...
  group('fromJson', () {
    test('should return a valid model when the JSON is recieved', () async {
      // arrange
      final Map<String, dynamic> jsonMap = json.decode(fixture('course/course.json'));
      // act
    ...
    test('should return a calid model when the JSON is recieved', () async {
      ...
      final Map<String, dynamic> jsonMap =
          json.decode(fixture('course/course_department.json'));
      // act
