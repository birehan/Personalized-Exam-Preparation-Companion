...
void main() {
  ...
  final chatBody = ChatBody(isContest: true, questionId: "questionId", userQuestion: "userQuestion", chatHistory: chatHistory);
  ...
  const chatResponse =  ChatResponse(messageResponse: "message response");
   ...
   test(
    ...
    () async {
      when(mockCourseRepository.chat(chatBody.isContest, chatBody.questionId, chatBody.userQuestion, chatHistory))
      ...
      verify(mockCourseRepository.chat(chatBody.isContest, chatBody.questionId, chatBody.userQuestion, chatHistory));
