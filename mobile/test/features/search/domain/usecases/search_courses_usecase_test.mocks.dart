...
// in skill_bridge_mobile/test/features/search/domain/usecases/search_courses_usecase_test.dart.
...
class MockSearchRepository extends _i1.Mock implements _i3.SearchRepository {
  @override
  _i4.Future<_i2.Either<_i5.Failure, List<_i3.Course>>> searchCourses(
          String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #searchCourses,
