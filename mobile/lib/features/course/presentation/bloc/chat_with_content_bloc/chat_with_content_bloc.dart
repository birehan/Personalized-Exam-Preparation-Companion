...
class ChatWithContentBloc
  ...
  void _onSendChat(
      SendChatWithContentEvent event, Emitter<ChatWithContentState> emit) async {
  ...
  ChatWithContentState _failureOrChat(Either<Failure, ChatResponse> chatOrFailure) {
    return chatOrFailure.fold(
      (l) => const SendChatWithContentState(status: ChatStatus.error),
