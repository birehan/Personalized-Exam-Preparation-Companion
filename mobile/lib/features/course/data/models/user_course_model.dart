...
class UserCourseModel extends UserCourse {
  ...
  Map<String, dynamic> toJson() {
    final courseModel = CourseModel(id: course.id, name: course.name, departmentId: course.departmentId, description: course.description, numberOfChapters: course.numberOfChapters, ects: course.ects, image: course.image, grade: course.grade, cariculumIsNew: course.cariculumIsNew);
    return {
      '_id': id,
      'userId': userId,
