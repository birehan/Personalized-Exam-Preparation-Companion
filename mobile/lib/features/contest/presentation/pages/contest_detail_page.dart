...
import 'package:prepgenie/core/utils/creat_links.dart';
...
import 'package:prepgenie/features/contest/presentation/bloc/registerContest/register_contest_bloc.dart';
import 'package:prepgenie/features/contest/presentation/widgets/contest_ranking_section.dart';
import 'package:prepgenie/features/contest/presentation/widgets/weekly_prizes_widget.dart';
    ...
    showGeneralDialog(
      ...
      pageBuilder: (context, anim1, anim2) => AlertDialog(
        content: Column(
          ...
          children: [
            const Text('You have registered to the contest successfully.'),
            SizedBox(height: 3.h),
            Row(
          ...
          child: BlocBuilder<ContestDetailBloc, ContestDetailState>(
            builder: (context, state) {
              if (state is ContestDetailFailedState) {
                ...
                final contestCategories = state.contestDetail.contestCategories;
                      ...
                      return [
                        SliverAppBar(
                          ...
                          actions: [
                            IconButton(
                              onPressed: () {
                                createContestLink(contestId: widget.contestId)
                                    .then(
                                  (value) => Share.share(
                                    value,
                              ...
                              children: [
                                if (state.contestDetail.isUpcoming &&
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'The contest is live.', //! this has to be changed
                                      style: GoogleFonts.poppins(
                                        color: Colors.white,
                                      ),
                                    ),
                                ...
                                (state.contestDetail.hasRegistered &&
                                    ...
                                    ? ContestResultWidget(
                                        ...
                                        points: state.contestDetail.userScore,
                                                        ...
                                                        child: BlocBuilder<
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return Text(
                                                              state.contestDetail
                                                                      .isUpcoming
                                                                  ? 'Register Now' //! this has to be changed
                                                                  : 'Try Contest', //! this has to be changed
                                                              style: GoogleFonts
                                                                  .poppins(
                                                                color: Colors
                                                                    .white,
                                  ...
                                  children: [
                                    ListView.separated(
                                      ...
                                      itemBuilder: (context, index) => InkWell(
                                        onTap: () {
                                          if (state.contestDetail.hasEnded ||
                                            ...
                                            showPopupOnCompletingContest(
                                              ...
                                              title: state
                                                      .contestDetail.hasEnded
                                                  ? 'Contest has ended!'
                                                  : 'You have submitted for this category successfully!',
                                              isSubmitted:
                                                  !state.contestDetail.hasEnded,
                                            );
                                          }
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      if (state.contestDetail
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            '${contestCategories[index].userScore}pts',
                                                            style: GoogleFonts
                                                                .poppins(
                                                              color:
                                                                  const Color(
                                                  ...
                                                  ConstrainedBox(
                                                    ...
                                                    child: Text(
                                                      '${contestCategories[index].numberOfQuestion.toString()} questions',
                                                      style:
                                                          GoogleFonts.poppins(
                                                        color: Colors.black,
                                                        fontSize: 14,
                                    ...
                                    if (!state.contestDetail.hasRegistered ||
                                        (state.contestDetail.contestType ==
                                                'live' &&
                                            !state.contestDetail.hasEnded &&
                                            !state.contestDetail.isLive))
    ...
    _timer = Timer.periodic(const Duration(seconds: 1), (Timer timer) {
      setState(() {
        ...
        if (duration < 0) {
          ...
          _timer.cancel();
          timeLeftMessage = 'Contest has ended.';
