...
RouteBase get $homePageRoute => GoRouteData.$route(
      ...
      routes: [
        ...
        GoRouteData.$route(
          ...
          factory: $MockQuestionPageRouteExtension._fromState,
          routes: [
            GoRouteData.$route(
              path: 'chat',
              name: 'mocksChatpage',
...
extension $MockQuestionPageRouteExtension on MockQuestionPageRoute {
  static MockQuestionPageRoute _fromState(GoRouterState state) =>
      MockQuestionPageRoute(
        $extra: state.extra as MockExamQustionPageParams,
      );
